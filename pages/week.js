...
export async function getServerSideProps({ query }) {
  ...
  try {
    const res = await fetch(`https://api.vvhan.com/api/horoscope?type=${type}&time=week`);
...
export default function Week({ apiData, lang, selectedZodiac }) {
        ...
        <div className="content">
          ...
          {apiData.success ? (
            <div className="horoscope-card">
              ...
              {apiData.data.todo && (
                <div className="fortune-section">
                  <div className="fortune-title">本周宜忌</div>
